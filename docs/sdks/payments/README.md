...
req = operations.InitializePaymentRequest(
    request_body=operations.Schemas(
    ...
    payment_method=operations.PaymentMethod(
        payment_data=operations.PaymentData(),
        type=operations.Type.PAYPAL,
    ),
    shopper_identity=operations.PaypalPaymentInputInitializeShopperIdentity(
        create_bolt_account=True,
...
req = operations.UpdatePaymentRequest(
    request_body=operations.SavedPaymentInputUpdateSchemas(
    cart=shared.CartCreate(
        add_ons=[
            shared.CartAddOn(
                name='string',
    ...
    payment_method=operations.SavedPaymentInputUpdatePaymentMethod(
        payment_data=operations.SavedPaymentInputUpdatePaymentData(),
        type=operations.SavedPaymentInputUpdateType.SAVED_PAYMENT_METHOD,
    ),
    shopper_identity=operations.SavedPaymentInputUpdateShopperIdentity(
        create_bolt_account=True,
