...
class UpdateTransactionType(str, Enum):
...
class UpdateTransactionSplits:
    ...
    type: Optional[UpdateTransactionType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""**Nullable** for Transactions Details."""
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateTransactionAuthRejectionDetails:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateTransactionTransactionRejectionDetails:
    auth_rejection_details: Optional[UpdateTransactionAuthRejectionDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_rejection_details'), 'exclude': lambda f: f is None }})
...
class UpdateTransactionResponseBody:
    ...
    splits: Optional[List[UpdateTransactionSplits]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('splits'), 'exclude': lambda f: f is None }})
    ...
    transaction_rejection_details: Optional[UpdateTransactionTransactionRejectionDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transaction_rejection_details'), 'exclude': lambda f: f is None }})
