...
class EditAddressResponseBody:
    ...
    door_code: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('door_code'), 'exclude': lambda f: f is EditAddressResponseBody.UNSET }})
    ...
    metadata: Optional[shared_metadata.Metadata] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metadata'), 'exclude': lambda f: f is EditAddressResponseBody.UNSET }})
    ...
    region_code: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('region_code'), 'exclude': lambda f: f is EditAddressResponseBody.UNSET }})
    ...
    street_address3: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('street_address3'), 'exclude': lambda f: f is EditAddressResponseBody.UNSET }})
    r"""Any additional street address details."""
    street_address4: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('street_address4'), 'exclude': lambda f: f is EditAddressResponseBody.UNSET }})
    r"""Any additional street address details."""
