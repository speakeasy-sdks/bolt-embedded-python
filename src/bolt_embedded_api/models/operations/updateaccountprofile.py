...
class UpdateAccountProfileRequestBody:
    ...
    metadata: Optional[shared_metadata.Metadata] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metadata'), 'exclude': lambda f: f is UpdateAccountProfileRequestBody.UNSET }})
