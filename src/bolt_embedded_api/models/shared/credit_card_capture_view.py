...
class CreditCardCaptureView:
    ...
    splits: Optional[TransactionSplitsView] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('splits'), 'exclude': lambda f: f is None }})
