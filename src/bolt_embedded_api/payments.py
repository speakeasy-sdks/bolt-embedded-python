...
class Payments:
    ...
    def finalize_payment(self, request: operations.FinalizePaymentRequest, security: operations.FinalizePaymentSecurity) -> operations.FinalizePaymentResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.FinalizePayment200ApplicationJSON])
                res.finalize_payment_200_application_json_object = out
            else:
    ...
    def initialize_payment(self, request: operations.InitializePaymentRequest, security: operations.InitializePaymentSecurity) -> operations.InitializePaymentResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.InitializePayment200ApplicationJSON])
                res.initialize_payment_200_application_json_object = out
            else:
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
        elif http_res.status_code == 403:
            pass
    ...
    def update_payment(self, request: operations.UpdatePaymentRequest, security: operations.UpdatePaymentSecurity) -> operations.UpdatePaymentResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdatePayment200ApplicationJSON])
                res.update_payment_200_application_json_object = out
            else:
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
        elif http_res.status_code == 403:
            pass
