...
class Account:
    ...
    def add_address(self, request: operations.AddAddressRequest, security: operations.AddAddressSecurity) -> operations.AddAddressResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "address_account", 'json')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.AddAddress200ApplicationJSON])
                res.add_address_200_application_json_object = out
            else:
    ...
    def create_account(self, request: operations.CreateAccountRequest, security: operations.CreateAccountSecurity) -> operations.CreateAccountResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_account_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = f'speakeasy-sdk/{self.sdk_configuration.language} {self.sdk_configuration.sdk_version} {self.sdk_configuration.gen_version} {self.sdk_configuration.openapi_doc_version}'
    ...
    def delete_payment_method(self, request: operations.DeletePaymentMethodRequest, security: operations.DeletePaymentMethodSecurity) -> operations.DeletePaymentMethodResponse:
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorsBoltAPIResponse])
                res.errors_bolt_api_response = out
            else:
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
    ...
    def edit_address(self, request: operations.EditAddressRequest, security: operations.EditAddressSecurity) -> operations.EditAddressResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.EditAddress200ApplicationJSON])
                res.edit_address_200_application_json_object = out
            else:
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
    ...
    def replace_address(self, request: operations.ReplaceAddressRequest, security: operations.ReplaceAddressSecurity) -> operations.ReplaceAddressResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.ReplaceAddress200ApplicationJSON])
                res.replace_address_200_application_json_object = out
            else:
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
